...
const Hero = () => {
  ...
  return (
      <section id="home" className="flex md:flex-row flex-col sm:py-16 py-6 px-4">
              ...
              <div className="relative">
                  <form onSubmit={handleSubmit}>
                    <input
                        type="text"
                        value={recipe}
                        className="shadow-search border border-solid border-black max-w-[470px] mt-5 p-4 w-1/2 bg-[#f5fbef]"
